...
/***/ function(module, exports, __webpack_require__) {
	...
	var middlewares = (0, _redux.applyMiddleware)(_reduxThunk2.default, logger);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerInterface;

	var _reducerInterface2 = __webpack_require__(225);

	var _reducerInterface3 = _interopRequireDefault(_reducerInterface2);

	var _user = __webpack_require__(183);

	var _user2 = __webpack_require__(184);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

	exports.default = (0, _reducerInterface3.default)(_user2.initialState, _user2.User, (_reducerInterface = {}, _defineProperty(_reducerInterface, _user.USER_REQUEST, function () {
	  this.fetching();
	}), _defineProperty(_reducerInterface, _user.USER_LOGIN, function (_ref) {
	  var user = _ref.user;

	  this.full(user);
	}), _defineProperty(_reducerInterface, _user.USER_LOGIN_NOT_FULL, function (_ref2) {
	  var user = _ref2.user;

	  this.notFull(user);
	}), _defineProperty(_reducerInterface, _user.USER_AUTHENTICATION_ERROR, function () {
	  this.authenticationError();
	}), _defineProperty(_reducerInterface, _user.USER_SET_ADDITIONAL_DATA_USERNAME, function (_ref3) {
	  var username = _ref3.username;

	  this.setUsername(username);
	}), _defineProperty(_reducerInterface, _user.USER_ADDITIONAL_DATA_USERNAME_EMPTY, function () {
	  this.usernameIsEmpty();
	}), _defineProperty(_reducerInterface, _user.USER_ADDITIONAL_DATA_USERNAME_INVALID, function () {
	  this.usernameIsInvalid();
	}), _defineProperty(_reducerInterface, _user.USER_LEAVE, function () {
	  this.leave();
	}), _defineProperty(_reducerInterface, _user.USER_LOGOUT, function () {
	  this.logout();
	}), _reducerInterface));
...
/***/ function(module, exports) {
	...
	var USER_LOGIN_NOT_FULL = exports.USER_LOGIN_NOT_FULL = "USER_LOGIN_NOT_FULL";
...
/***/ function(module, exports) {
	...
	var User = exports.User = function () {
	  ...
	  _createClass(User, [{
	    ...
	    key: "full",
	    value: function full(user) {
	      return this.merge(_extends({
	        isFetching: false,
	        isLogged: true,
	        isRequireAdditionalData: false
	      }, user));
	    ...
	    value: function authenticationError() {
	      return this.merge({
	        isLogged: false,
	        isLoading: false,
	    ...
	    key: "usernameIsEmpty",
	    value: function usernameIsEmpty() {
	      return this.merge({
	        additionalData: {
	          username: {
	            isEmpty: true
	    ...
	    key: "usernameIsInvalid",
	    value: function usernameIsInvalid() {
	      return this.merge({
	        additionalData: {
	          username: {
	            isInvalid: true
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsCssTransitionGroup = __webpack_require__(189);

	var _reactAddonsCssTransitionGroup2 = _interopRequireDefault(_reactAddonsCssTransitionGroup);

	var _AuthenticationError = __webpack_require__(196);

	var _AuthenticationError2 = _interopRequireDefault(_AuthenticationError);

	var _Loading = __webpack_require__(197);

	var _Loading2 = _interopRequireDefault(_Loading);

	var _Username = __webpack_require__(198);

	var _Username2 = _interopRequireDefault(_Username);

	var _MainButton = __webpack_require__(199);

	var _MainButton2 = _interopRequireDefault(_MainButton);

	var _AdditionalData = __webpack_require__(209);

	var _AdditionalData2 = _interopRequireDefault(_AdditionalData);

	var _user = __webpack_require__(201);

	var _connection = __webpack_require__(202);

	var _multiStorage = __webpack_require__(208);
	  ...
	  _createClass(UserPanel, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        authenticationError && _react2.default.createElement(_AuthenticationError2.default, null),
	        ...
	        username && _react2.default.createElement(_Username2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(Username);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainButton = exports.MainButton = function (_Component) {
	  ...
	  _createClass(MainButton, [{
	    ...
	    value: function buttonHandler(event) {
	      ...
	      if (!isLogged && !isRequireAdditionalData && !authenticationError) {
	        ...
	        (0, _connection.unsetVerificationData)();
	...
	function mapStateToProps(_ref) {
	  ...
	  var isFetching = _ref$user.isFetching;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadedNotFull(user) {
	  return {
	    type: _user.USER_LOGIN_NOT_FULL,
	    user: user
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wsSession = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cookie = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rng = __webpack_require__(205);
...
/***/ function(module, exports) {
	...
	function popup(url, _ref) {
	  ...
	  var _window = window;
	  var screenLeft = _window.screenLeft;
	  var screenTop = _window.screenTop;
	  var innerWidth = _window.innerWidth;
	  var innerHeight = _window.innerHeight;

	  var left = screenLeft + innerWidth / 2 - width / 2;
	  var top = screenTop + innerHeight / 2 - height / 2;
...
/***/ function(module, exports) {
	...
	function getItems() {
	  ...
	  for (var _len = arguments.length, requiredItems = Array(_len), _key = 0; _key < _len; _key++) {
	    requiredItems[_key] = arguments[_key];
	  }
	...
	function removeItems() {
	  for (var _len2 = arguments.length, itemsToRemove = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdditionalData = exports.AdditionalData = function (_Component) {
	  ...
	  _createClass(AdditionalData, [{
	    ...
	    key: "render",
	    value: function render() {
	      var sendUsername = this.sendUsername;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TOKEN_VALIDATOR = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;
	var REFRESH_TOKEN_VALIDATOR = /.*/;
	...
	function idValidator(id) {
	  if (id) {
	    if (typeof id === "number") return null;else return _codes.USERS_INVALID_ID;
	  } else return _codes.USERS_EMTPY_ID;
	}

	function emailValidator(email) {
	  if (email) {
	    if (EMAIL_VALIDATOR.test(email)) return null;else return _codes.USERS_INVALID_EMAIL;
	  } else return _codes.USERS_EMTPY_EMAIL;
	}

	function usernameValidator(username) {
	  if (username) {
	    if (USERNAME_VALIDATOR.test(username)) return null;else return _codes.USERS_INVALID_USERNAME;
	  } else return _codes.USERS_EMTPY_USERNAME;
	}

	function tokenValidator(token) {
	  if (token) {
	    if (TOKEN_VALIDATOR.test(token)) return null;else return _codes.USERS_INVALID_TOKEN;
	  } else return _codes.USERS_EMTPY_TOKEN;
	}
...
/***/ function(module, exports) {
	...
	var USERS_UNKNOWN_ERROR = exports.USERS_UNKNOWN_ERROR = 50;
	var USERS_EMTPY_ID = exports.USERS_EMTPY_ID = 51;
	var USERS_INVALID_ID = exports.USERS_INVALID_ID = 52;
	var USERS_EMTPY_EMAIL = exports.USERS_EMTPY_EMAIL = 52;
	var USERS_INVALID_EMAIL = exports.USERS_INVALID_EMAIL = 53;
	var USERS_USED_EMAIL = exports.USERS_USED_EMAIL = 54;
	var USERS_EMTPY_USERNAME = exports.USERS_EMTPY_USERNAME = 55;
	var USERS_INVALID_USERNAME = exports.USERS_INVALID_USERNAME = 56;
	var USERS_USED_USERNAME = exports.USERS_USED_USERNAME = 57;
	var USERS_EMTPY_TOKEN = exports.USERS_EMTPY_TOKEN = 58;
	var USERS_INVALID_TOKEN = exports.USERS_INVALID_TOKEN = 59;
	var USERS_EMTPY_REFRESH_TOKEN = exports.USERS_EMTPY_REFRESH_TOKEN = 60;
	var USERS_INVALID_REFRESH_TOKEN = exports.USERS_INVALID_REFRESH_TOKEN = 61;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".user-panel {\n  position: absolute;\n  top: 15px;\n  right: 15px;\n  display: flex;\n  flex-direction: row;\n  align-items: stretch;\n}\n.user-panel .main-button {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 30px;\n  height: 30px;\n  border-radius: 15px;\n  font-size: 30px;\n  cursor: pointer;\n  transition: text-shadow 150ms ease-in-out, color 150ms ease-in-out;\n}\n.user-panel .main-button.loading {\n  color: #f0ad4e;\n}\n.user-panel .main-button.required-username {\n  color: #f0ad4e;\n}\n.user-panel .main-button.logged {\n  color: #d9534f;\n}\n.user-panel .main-button.authentication-error {\n  color: #d9534f;\n}\n.user-panel .loading {\n  position: absolute;\n  transform: translateX(-100%);\n  transition: opacity 150ms ease-in-out;\n}\n.user-panel .loading.enter {\n  opacity: 0;\n}\n.user-panel .loading.enter.enter-active {\n  opacity: 1;\n}\n.user-panel .loading.leave {\n  opacity: 1;\n}\n.user-panel .loading.leave.leave-active {\n  opacity: 0;\n}\n.user-panel .additional-data {\n  position: absolute;\n  display: flex;\n  align-items: stretch;\n  height: 100%;\n  transform: translateX(calc(-100% - 5px));\n}\n.user-panel .additional-data > .username {\n  font-size: 14px;\n  border-width: 1px;\n  border-style: solid;\n  border-color: black;\n}\n.user-panel .additional-data > .username.empty {\n  border-color: #f0ad4e;\n}\n.user-panel .additional-data > .username.invalid {\n  border-color: #d9534f;\n}\n.user-panel .additional-data.enter {\n  opacity: 0;\n}\n.user-panel .additional-data.enter.enter-active {\n  opacity: 1;\n  transition: opacity 150ms ease-in-out;\n}\n.user-panel .additional-data.leave {\n  opacity: 1;\n}\n.user-panel .additional-data.leave.leave-active {\n  opacity: 0;\n  transition: opacity 150ms ease-in-out;\n}\n.user-panel > .username {\n  position: absolute;\n  display: flex;\n  align-items: center;\n  height: 100%;\n  white-space: nowrap;\n  transform: translateX(calc(-100% - 5px));\n  transition: opacity 150ms ease-in-out;\n}\n.user-panel > .username.enter {\n  opacity: 0;\n}\n.user-panel > .username.enter.enter-active {\n  opacity: 1;\n}\n.user-panel > .username.leave {\n  opacity: 1;\n}\n.user-panel > .username.leave.leave-active {\n  opacity: 0;\n}\n.user-panel .authentication-error-panel {\n  position: absolute;\n  display: flex;\n  align-items: center;\n  height: 100%;\n  white-space: nowrap;\n  color: #d9534f;\n  transform: translateX(calc(-100% - 5px));\n  transition: opacity 150ms ease-in-out;\n}\n.user-panel .authentication-error-panel.enter {\n  opacity: 0;\n}\n.user-panel .authentication-error-panel.enter.enter-active {\n  opacity: 1;\n}\n.user-panel .authentication-error-panel.leave {\n  opacity: 1;\n}\n.user-panel .authentication-error-panel.leave.leave-active {\n  opacity: 0;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uniqueState = __webpack_require__(186);

	var _uniqueState2 = _interopRequireDefault(_uniqueState);

	var _superMerge = __webpack_require__(228);
